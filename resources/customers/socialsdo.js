...
let SocialDAO = function() {
    ...
    this.retrieveById = async function(pk,  fields, context) {
        ...
        try {
            ...
            logging.debug_message("SocialDAO.retrieveById: error = ", err);
    ...
    this.retrieveByTemplate = async function(template, fields, context) {
        ...
        try {
            ...
            logging.debug_message("SocialDAO.retrieveByTemplate: error = ", err);
            return Promise.reject(err);
        }
    };
    ...
    this.create = function(data, context) {
        ...
        return new Promise(async function (resolve, reject) {
            ...
            try {
                ...
                logging.error_message("socialInfoDo.create: Error = ", err);
                reject(err);
            };
    ...
    self.update = function(template, fields, context) {
        ...
        return new Promise(async function (resolve, reject) {
            ...
            try {
                ...
                logging.error_message("socialInfoDo.update: Error = ", err);
                reject(err);
            };
    ...
    self.delete = function(template, context) {
        ...
        return new Promise(async function (resolve, reject) {
            ...
            try {
                ...
                logging.error_message("socialInfoDo.delete: Error = ", err);
                reject(err);
            };
